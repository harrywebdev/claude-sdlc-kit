...
emit "Claude monitor is not running on port ${PORT} - run /claude-monitor:start to see why." "Claude monitor is not running on port ${PORT} - run /claude-monitor:start to see why."
